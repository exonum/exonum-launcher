...
class TestConfiguration(unittest.TestCase):
    ...
    def test_sample_parse(self) -> None:
        ...
        self.assertEqual(cryptocurrency.name, "exonum-cryptocurrency")
        self.assertEqual(cryptocurrency.version, "0.1.0")
    ...
    def test_parse_plugins_runtime_only(self) -> None:
        ...
        expected_layout = {"runtime": {"sample3": "tests.spec_loaders.TestRuntimeSpecLoader"}, "artifact": {}}
